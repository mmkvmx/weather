            ...
            <div className={styles.table}>
                <div className={styles.row}>
                    <div className={styles.cell}>
                        <img src={`${process.env.PUBLIC_URL}img/humidity.png`} alt="Влажность" />
                        <p className={styles.value}>{humidity}%</p>
                        <b>Влажность</b>
                    </div>
                    <div className={styles.cell}>
                        <img height={50} src={`${process.env.PUBLIC_URL}img/wind.png`} alt="Ветер" />
                        <p>{wind} м/с</p>
                        <b>Ветер</b>
                    </div>
                </div>
                <div className={styles.row}>
                    <div className={styles.cell}>
                        <img src={`${process.env.PUBLIC_URL}img/pressure.png`} alt="Давление" />
                        <p>{Math.round(pressure / 1.333)} мм рт.ст</p>
                        <b>Давление</b>
                    </div>
                    <div className={styles.cell}>
                        <img src={`${process.env.PUBLIC_URL}img/uv.png`} alt="УФ индекс" />
                        <p>{uv}</p>
                        <b>УФ</b>
                    </div>
                </div>
